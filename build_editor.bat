...
REM Debug
rem cl %opts% -I%incl% -I%code%\..\src\ %debug% %SOURCES% -Fe:osked.exe /link -incremental:no %link_opts% opengl32.lib winmm.lib gdi32.lib 

REM Release
cl %opts% -I%incl% -I%code%\..\src\ %release% %SOURCES% -Fe:osked.exe /link -incremental:no %link_opts% opengl32.lib winmm.lib gdi32.lib 
